...
/**
 * Implements the SiLAS Role Propagation ADR pattern. Forwards the inbound SiLAS-enriched ID token
 * via the X-Authorization header alongside the primary OBO token specifically for Access Data Store
 * (ADS) requests.
 */
