...
public record DraftSummary(
    @Schema(
        ...
        UUID draftId,
    @Schema(description = "The form flow this draft belongs to.", example = "PRIOR_AUTHORITY")
        String draftType,
    @Schema(description = "Timestamp the draft was last updated.", example = "2026-05-19T12:00:00Z")
