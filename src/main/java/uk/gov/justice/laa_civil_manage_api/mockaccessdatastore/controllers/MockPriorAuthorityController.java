...
@Tag(
    ...
    description =
        "Mock of the Access Data Store endpoint that accepts prior-authority submissions.")
@RestController
...
public class MockPriorAuthorityController {
  ...
  @Operation(
      ...
      description =
          "Accepts a prior-authority submission for the given application. "
  ...
  public ResponseEntity<PriorAuthorityApplicationResponse> submit(
    ...
    URI location =
        URI.create(
            "/mock-access-data-store/applications/"
                + applicationId
                + "/prior-authority/"
